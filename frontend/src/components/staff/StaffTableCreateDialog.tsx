...
export function StaffTableCreateDialog({ open, onClose, onSaved }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(err instanceof ApiError ? err.message : "Tạo bàn thất bại");
    } finally {
      setPending(false);
    }
  }
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="create-table-title" className="font-serif text-xl font-semibold text-brand-900">
          Thêm bàn
        </h2>
